---
title: "Trans healthcare access in Iraq tightening — pharmacy compliance shift since Law 14"
description: "Anecdotal reports indicate Iraqi pharmacies are more cautious about hormone sales since the April 2024 law criminalized 'biological sex change for non-medical reasons.' Some pharmacies now require prescriptions or refuse to stock estradiol."
lang: en
pubDate: 2024-09-20
severity: medium
category: legal
source: "Community reports / Iraqi Social Progress Collective"
affected: "Trans Iraqis seeking HRT through pharmacy channels"
keywords: "Iraq HRT pharmacy, Iraq estradiol pharmacy, Iraq hormones Law 14, trans healthcare Iraq, Iraqi pharmacy hormones, Estrofem العراق, العلاج الهرموني العراق, مذخر العراق"
---

Following the passage of [Law No. 14 in April 2024](/en/security-alerts/law-14-2024-passed), the collective and partners have observed and received reports of changes in how Iraqi pharmacies handle hormone medications used in gender-affirming care. The changes are not uniform; some pharmacies operate as before, others have become noticeably more cautious.
...
- **Read all our HRT guides first** — see [HRT in Iraq overview](/en/guides/hrt-overview), [sourcing](/en/guides/hrt-sourcing-iraq), [pharmacy script](/en/guides/hrt-pharmacy-script), [monitoring](/en/guides/hrt-monitoring), and [risks](/en/guides/hrt-risks).
...
- **Factor in supply risk.** Starting HRT means committing to long-term supply. If you cannot reliably source for 12+ months, the risks of intermittent or interrupted HRT are significant — see [risks](/en/guides/hrt-risks).
...
For the full scripts in Arabic and English, see [Pharmacy Script](/en/guides/hrt-pharmacy-script).
...
We will update this alert as more information becomes available. If you have direct experience — recent pharmacy interactions, prescription requests, or refusals — please [report it confidentially](/en/feedback). Your reports help calibrate our guidance.
