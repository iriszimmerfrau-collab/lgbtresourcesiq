---
title: "Dating app entrapment: armed groups using Grindr, Hornet to lure LGBTQ+ Iraqis"
description: "Human Rights Watch documented a sustained pattern of armed groups using dating apps to identify, lure, and attack queer Iraqis. Risk has increased since Law No. 14 passed in 2024."
lang: en
pubDate: 2022-03-23
severity: critical
category: violence
...
The April 2024 [criminalization law](/en/security-alerts/law-14-2024-passed) means that even if police discover an attack, victims face their own criminal exposure for the same-sex contact that led to the trap. Many victims do not report. Attackers know this and act accordingly.
...
For more detailed safety guidance, see [Digital Safety](/en/safety) and the [FAQ](/en/faq).

## If you have been a victim

You are not alone. Even if reporting to Iraqi authorities is unsafe, you can:

- Reach out to us via [the community page](/en/community) — we can sometimes connect you with international advocacy contacts.
- Document what happened with timestamps and screenshots if you can do so safely.
- If you have urgent physical safety needs, the [honor violence guide](/en/guides/honor-violence) covers go-bag preparation and emergency exits.
