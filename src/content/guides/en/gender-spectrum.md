---
title: "The gender spectrum — beyond man and woman"
description: "Gender is not two boxes. Non-binary, genderfluid, agender, bigender, demigender, two-spirit — a guide to the full range of gender identities, including identities recognized in Arab and Islamic history."
lang: en
pubDate: 2026-05-02
category: identity
order: 7
keywords: "gender spectrum, non-binary, genderfluid, agender, bigender, demigender, two-spirit, third gender, mukhannathūn, hijra, الجندر, غير ثنائي, خنثى, متحول"
---
...
A non-binary person may or may not pursue medical transition. They may use any pronouns, including he, she, they, or neopronouns (see [Inahuf](/en/guides/arabic-neopronouns)). They may or may not "look androgynous" — gender presentation is independent of gender identity.
...
These categories existed long before European colonialism imposed strict gender binaries on much of the world. The current pressure to fit into "man or woman" is itself, in many places, a colonial artifact. (See [LGBTQIA+ history](/en/guides/lgbtqia-history) for more.)
...
For a guide to Arabic gender-neutral pronouns specifically — built by the Iraqi queer community — see [Inahuf — the Iraqi Arabic neopronoun](/en/guides/arabic-neopronouns).
...
- [Gender](/en/guides/gender) — the foundational concept
- [Sex vs. gender](/en/guides/sex-vs-gender) — the central distinction
- [Pronouns](/en/guides/pronouns) — practical use
- [Inahuf — Arabic neopronouns](/en/guides/arabic-neopronouns) — the Iraqi system
- [LGBTQIA+ history](/en/guides/lgbtqia-history) — including mukhannathūn and other historical third-gender categories
