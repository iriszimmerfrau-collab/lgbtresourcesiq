---
title: "Pharmacy script — what to say"
description: "Tested Arabic-language scripts the collective has used to obtain HRT medications from Iraqi pharmacies, with English translations."
lang: en
pubDate: 2026-04-29
category: hrt
parentGuide: hrt
...
relatedGuides:
  ...
  - hrt-risks
commonQuestions:
  - q: "What exactly do I say to a pharmacist when asking for Estrofem or Androcur?"
    a: "Walk in alone with a clear photo of the medication box on your phone. Show the photo. Say the brand name aloud — \"Estrofem\" or \"Androcur\" — naturally, without explanation. If asked the strength, the photo answers that. Most pharmacists do not ask why once they recognise the box. If they ask why anyway, the cover stories below cover the common cases."
  - q: "What do I say if the pharmacist asks who the medication is for?"
...
> اكو، شكد تريد؟
> _(We have it, how much do you want?)_
>
> Customer: Buy what you need. Pay. Leave.

**Response B — they don't have it but can order:**
> ماكو، بس نطلبه من المذخر.
> _(We don't have it, but we can order it from the warehouse.)_
>
> Customer:
> > لو سمحت، اطلبه. متى يوصل؟
> > _(Please order it. When will it arrive?)_
>
...
> _(This is restricted / not available / we don't sell it.)_
>
...
**Pharmacist:**
> شتسوي بيه؟
> _(What are you using it for?)_

**Customer:**
> اخوي عنده سرطان بروستات وشعره يوگع، يحتاجه علمود يتعالج لأن التيست ماله عالي كلش.
> _(My brother has prostate cancer and his hair is falling out — he needs it for treatment because his testosterone is very high.)_
...
> _(The doctor prescribed it, but the prescription is at home with my brother.)_
...
> _(My mother takes it for her symptoms. The doctor prescribed it.)_
...
If you would like help finding a friendly pharmacist in your city, the [community channel](/en/community) can sometimes refer you. We do not list these pharmacies publicly because publicity is what would make them stop being safe.

## What NOT to say

A few things that will end a pharmacy interaction quickly:

- **Do not mention transition, gender, or any LGBTQ-related word.** Even at a pharmacy that might otherwise be helpful, the wrong word in the wrong moment can shift the social dynamic.
- **Do not name the chemical compound by its scientific name** (cyproterone acetate, estradiol hemihydrate). Use the brand name (Androcur, Estrofem) or just point at the photo.
- **Do not pull out a printed paper that says "transition" or "HRT" on it.** Even in English. Pharmacy staff often have basic English literacy.
- **Do not bring a partner who is visibly transitioning.** This dramatically increases scrutiny.
...
> _(I'll come back later, thanks.)_
...
In the worst case — if a pharmacist threatens to call your family or the authorities — leave the pharmacy and the area immediately. This is rare, but it has happened. **Do not return to that pharmacy.** If you can, [tell us](/en/community) so we can warn others.
