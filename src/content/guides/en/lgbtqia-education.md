---
title: "LGBTQIA+ basics. What the letters mean and why they matter"
description: "A plain-language introduction to LGBTQIA+: what each letter stands for, what these terms actually mean, and why the language matters. Written for queer Iraqis who never had access to honest information."
lang: en
pubDate: 2026-05-02
category: identity
order: 1
keywords: "LGBTQIA meaning, LGBT meaning Arabic, LGBTQ Iraq, queer education Iraq, مثلي معنى, متحول معنى, مجتمع الميم, كوير العراق, sexual orientation, gender identity, two-spirit, asexual, intersex, queer Baghdad"
---
...
- They are not a "phase." Adults have known and described these orientations and identities throughout recorded history, in every culture including Arab and Islamic ones (see [our history guide](/en/guides/lgbtqia-history)).
...
- They are not the same as each other. Sexual orientation (who you are attracted to), gender identity (who you are), gender expression (how you present), and biological sex (your body) are four separate dimensions. See [sex vs. Gender](/en/guides/sex-vs-gender).
...
2. **You can find your community.** Knowing the search terms is how queer Iraqis find each other, find guides like this one, and find support. See our [community page](/en/community).
...
For a deeper look at Arabic gender-neutral pronouns, see [Inahuf. The Iraqi Arabic neopronoun](/en/guides/arabic-neopronouns).

## What this guide series covers

The other pages in this section build out each concept:

- [Sex vs. Gender](/en/guides/sex-vs-gender). The central distinction that makes everything else make sense
- [Biological sex](/en/guides/sex-biological). What "sex" actually refers to, and how intersex bodies fit in
- [Gender](/en/guides/gender). What gender identity is and how it can differ from assigned sex
- [Sexual orientation](/en/guides/sexual-orientation). Who you are attracted to
- [The sexual spectrum](/en/guides/sexual-spectrum). Beyond gay/straight/bi
- [The gender spectrum](/en/guides/gender-spectrum). Beyond man/woman
- [Pronouns](/en/guides/pronouns). What they are and why they matter
- [Inclusive language](/en/guides/inclusive-language). Practical phrasing for daily use
- [LGBTQIA+ history](/en/guides/lgbtqia-history). Including Arab and Iraqi history
