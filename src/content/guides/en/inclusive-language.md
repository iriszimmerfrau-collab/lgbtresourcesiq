---
title: "Inclusive language — practical phrasing for daily use"
description: "How to talk about people without misgendering them, exclude no one, and avoid the small words that hurt. A practical guide for English and Arabic, including respectful phrasing for queer Iraqis."
lang: en
pubDate: 2026-05-02
category: identity
order: 10
keywords: "inclusive language, gender neutral language, how to be inclusive, respectful pronouns, inclusive Arabic, queer respect, اللغة الشاملة, لغة محايدة, kindness language, pronouns daily use"
---
...
- **For non-binary individuals who use انهف**, see [the inahuf guide](/en/guides/arabic-neopronouns) for the full conjugation system.
...
- [Pronouns](/en/guides/pronouns) — the deeper explanation
- [Inahuf — Arabic neopronouns](/en/guides/arabic-neopronouns) — for non-binary Arabic
- [Gender](/en/guides/gender) — what we are being inclusive about
- [LGBTQIA+ basics](/en/guides/lgbtqia-education) — vocabulary baseline
